...
var answer = __importStar(require("../routes/answers"));
...
exports.router.get('/', auth_1.auth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 3:
                error_1 = _c.sent();
                return [2 /*return*/, answer.serverError(res)];
            case 4: return [2 /*return*/];
        }
    });
}); });
exports.router.get('/me', auth_1.auth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, user_1.User.findById(req['user']['_id']).select('-password')];
            case 1:
                user = _a.sent();
                res.send(user);
                return [3 /*break*/, 3];
...
exports.router.post('/', auth_1.auth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var error, user, salt, _a, _b, token, error_3;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (!req['user']['isAdmin'])
                ...
                return [4 /*yield*/, user_1.User.findOne({ email: req.body.email })];
            case 1:
                user = _c.sent();
                if (user)
                    return [2 /*return*/, res.status(400).send('User already registered.')];
                user = new user_1.User(lodash_1.default.pick(req.body, ['name', 'email', 'password', 'isAdmin']));
